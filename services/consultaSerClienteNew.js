...
export function requestApiconsultaSerClienteNew(url, that) {
    ...
    my.request({
      ...
      data:{
        "data": {
            ...
            "inventarios": [],
            "mensajeRespuesta": "",
            "numeroCuenta": requestParameter.globalData.NumberAccount,
            "servicioActual": [],
            "servicioDisponible": [],
            "tipoRespuesta": "",
            "valorRenta": ""
      ...
      headers: {
        ...
        'X-MC-LINE': requestParameter.globalData.NumberAccount,
        'X-MC-LOB': '3',
